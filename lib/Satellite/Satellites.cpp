...
Transponder rs44Transponder({14593500, 14599500}, Payload::Mode::LSB, {43561000, 43567000}, Payload::Mode::USB, true);
...
Repeater so50Repeater(14585000, 43679500, Payload::Mode::FM);
...
Repeater issRepeater(14599000, 43780000, Payload::Mode::FM);
Satellite iss("ISS",
